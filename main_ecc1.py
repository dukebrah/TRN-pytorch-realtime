...
def main():
    ...
    categories, args.train_list, args.val_list, args.root_path, prefix = datasets_ecc1.return_dataset(args.dataset, args.modality)
    ...
    checkpoint = torch.load('model/TRN_jester_Ecc_BNInception_TRNmultiscale_segment8_best.pth.tar')
